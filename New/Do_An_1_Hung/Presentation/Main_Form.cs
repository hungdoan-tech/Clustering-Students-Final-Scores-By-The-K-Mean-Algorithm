...
namespace Do_An_1
{
    public partial class Main_Form : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //using (var Depar = new UniversityContext())
            //{

            //    var Dashboard =(from d in Depar.Grades
            //                     join s in Depar.Classes
            //                            on d.ClassID equals s.ClassID
            //                     select new
            //                     {
            //                         d.StudentID
            //                     }).Distinct();
            ...
            ////using(var NamePro = new UniversityContext())
            //{

            //    var Dashboard = (from nd in NamePro.Professors
            //                     where nd.ProfessorID.ToString() == this.ProfessorID.ToString()
            ...
            //                         s.DateOFBirth
            //                     }); ; ;.Distinct();
            //    dGVStudentManagement.DataSource = Dashboard.ToList();
        ...
        private void btnDashboard_Click(object sender, EventArgs e)
        {
            ...
            using (var Depar = new UniversityContext())
            {
                ...
                var Dashboard = (from d in Depar.Departments
                                 join s in Depar.Students
        ...
        private void cbb_Subjects_GradeForm_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void cbb_Classes_GradeForm_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            BLGrade grades = new BLGrade();
        ...
        private void txt_Search_GradeForm_TextChanged_1(object sender, EventArgs e)
        {
            BLGrade grades = new BLGrade();
